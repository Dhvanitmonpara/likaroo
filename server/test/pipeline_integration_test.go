...
func TestPipelineIntegration(t *testing.T) {
	...
	t.Run("E2E Text Note Detection and Extraction", func(t *testing.T) {
		...
		if res.Content == "" {
			t.Errorf("Content expected to be populated by Agent workflow")
		}
		if res.Notes == "" {
			t.Errorf("Notes expected to be generated by Agent workflow")
		}
		if len(res.Tags) == 0 {
			t.Errorf("Tags expected to be generated by Agent workflow")
		}
	})
}
